...
enum MiddleEarthTerrainProfile {
    ...
    ROHAN("rohan", 0x70AD45, 0.80F, 0.80F, 68, 4, 6, Surface.GRASS, false),
    ...
    MORDOR("mordor", 0x11100E, 2.00F, 0.00F, 72, 12, 9, Surface.STONE, false),
    MORDOR_MOUNTAINS("mordorMountains", 0x514D48, 2.00F, 0.00F, 126, 72, 32, Surface.STONE, false),
    GONDOR("gondor", 0x88B445, 0.80F, 0.80F, 65, 4, 6, Surface.GRASS, false),
    ...
    ITHILIEN("ithilien", 0x75A734, 0.90F, 0.90F, 67, 12, 9, Surface.GRASS, false),
    ...
    DAGORLAD("dagorlad", 0x6B5F45, 1.00F, 0.20F, 65, 1, 4, Surface.STONE, false),
    ...
    ADORNLAND("adornland", 0x779B4F, 0.70F, 0.60F, 68, 5, 6, Surface.GRASS, false),
    ...
    DOR_EN_ERNIL("dorEnErnil", 0x8EBF45, 0.90F, 0.90F, 64, 5, 6, Surface.GRASS, false),
    DOR_EN_ERNIL_HILLS("dorEnErnilHills", 0x82A043, 0.80F, 0.70F, 78, 12, 9, Surface.GRASS, false),
    FANGORN_WASTELAND("fangornWasteland", 0x677C4C, 0.70F, 0.40F, 68, 10, 8, Surface.COARSE_DIRT, false),
    ROHAN_WOODLANDS("rohanWoodlands", 0x578736, 0.90F, 0.90F, 68, 10, 8, Surface.PODZOL, false),
    GONDOR_WOODLANDS("gondorWoodlands", 0x59872B, 0.80F, 0.90F, 68, 5, 6, Surface.PODZOL, false),
    ...
    ITHILIEN_HILLS("ithilienHills", 0x6A9840, 0.70F, 0.70F, 81, 14, 10, Surface.GRASS, false),
    ...
    WHITE_DOWNS("whiteDowns", 0x9BCE79, 0.60F, 0.70F, 81, 14, 10, Surface.GRASS, false),
    ...
    NAN_UNGOL("nanUngol", 0x0A0501, 2.00F, 0.00F, 65, 10, 8, Surface.STONE, false),
    ...
    FAR_HARAD_JUNGLE("farHaradJungle", 0x4B7423, 1.20F, 0.90F, 68, 10, 8, Surface.SAND, false),
    ...
    FAR_HARAD_JUNGLE_EDGE("farHaradJungleEdge", 0x71882E, 1.20F, 0.80F, 68, 5, 6, Surface.SAND, false),
    ...
    DORWINION_HILLS("dorwinionHills", 0xCBD3A9, 0.90F, 0.80F, 88, 19, 12, Surface.GRASS, false),
    ...
    DOL_GULDUR("dolGuldur", 0x242F0F, 0.60F, 0.80F, 68, 12, 9, Surface.STONE, false),
    ...
    UDUN("udun", 0x010000, 1.50F, 0.00F, 68, 17, 11, Surface.STONE, false),
    GORGOROTH("gorgoroth", 0x211D1D, 2.00F, 0.00F, 81, 5, 6, Surface.STONE, false),
    MORGUL_VALE("morgulVale", 0x152D19, 1.00F, 0.00F, 68, 2, 5, Surface.STONE, false),
    EASTERN_DESOLATION("easternDesolation", 0x5C5C47, 1.00F, 0.30F, 68, 5, 6, Surface.STONE, false),
    ...
    BEACH_WHITE("beachWhite", 0xEDEDED, 0.80F, 0.80F, 65, 5, 6, Surface.SAND, false),
    ...
    RIVENDELL_HILLS("rivendellHills", 0xD8D5B1, 0.70F, 0.80F, 126, 12, 9, Surface.GRASS, false),
    FAR_HARAD_JUNGLE_MOUNTAINS("farHaradJungleMountains", 0x635A46, 1.00F, 1.00F, 120, 36, 19, Surface.SAND, false),
