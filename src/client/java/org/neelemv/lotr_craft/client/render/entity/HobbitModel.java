...
public class HobbitModel extends HumanoidModel<HobbitRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(Lotr_craft.MOD_ID, "hobbit"), "main");

    public HobbitModel(net.minecraft.client.model.geom.ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("hat",
                CubeListBuilder.create()
                        .texOffs(0, 32)
                        .addBox(-4.0F, -8.0F, -4.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.5F)),
                PartPose.ZERO);
        ...
        root.addOrReplaceChild("right_arm",
                ...
                PartPose.offset(-5.0F, 6.8F, 0.0F));
        ...
        PartDefinition rightLeg = root.addOrReplaceChild("right_leg",
                ...
                PartPose.offset(-1.9F, 16.8F, 0.0F));
        rightLeg.addOrReplaceChild("right_foot",
                CubeListBuilder.create()
                        .texOffs(40, 32)
                        .addBox(-2.0F, 10.0F, -5.0F, 4.0F, 2.0F, 3.0F, deformation),
                PartPose.rotation(0.0F, 0.17453292F, 0.0F));
