...
public class OrcHumanoidNpcModel extends HumanoidModel<HumanoidNpcRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(Lotr_craft.MOD_ID, "orc_humanoid_npc"), "main");

    public OrcHumanoidNpcModel(ModelPart root) {
        super(root);
    }
